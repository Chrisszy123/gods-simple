      ...
      <div className="relative z-10 max-w-[680px] mx-auto px-6 py-16">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          {[
            ...
            'Two votes. One show. The Eviction vote determines who stays on the stage — the bottom performers face elimination each week. The God of the Week vote crowns the standout performer of the round.',
            'All voting is powered by direct bank transfers to each contestant\'s dedicated Wema Bank account. Every naira you send is a vote. No apps. No sign-up. Just transfer and your vote is counted live.',
        ...
        <div className="mt-14 mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <VotingCard
              ...
              body="Transfer to your favourite contestant's Wema Bank account. ₦200 = 1 vote. Everyone is at risk of eviction — there is no safe zone this round. No cap — vote as many times as you like."
            />
            <VotingCard
              emoji="⚡"
              title="GOD OF THE WEEK"
              body="A fresh set of contestants compete every week for the God of the Week title. Transfer to their Wema Bank account — ₦100 = 1 vote. The contestant with the most votes at the end of the week wins."
            />
          </div>
        </div>
